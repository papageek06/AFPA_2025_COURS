...
if($_POST) {
    ...
    if(isset($_POST['modifyProduct'])) {
        ...
        if(isset($urlPictureForDB)) {
            $sql .= ",picture = '$urlPictureForDB'";
        }
        $sql .= "WHERE id = '$id'";
    ...
    ////// AJOUT
        ...
        VALUES('$reference', '$category', '$title', '$description', '$color', '$size', '$public', '$price', '$urlPictureForDB', '$stock)");
